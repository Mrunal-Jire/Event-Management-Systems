    ...
    <div className="position: fixed">
      ...
      <nav className=" fixed-top mynav text-danger bg-info">
        <div className="row nav d-flex">
          ...
          <div className="col-sm-1 col-md-1 col-lg-1 ms-2">
            <Link to="/book" className="nav-link text-info">
              Book Event
            </Link>
          </div>
          <div className="col-sm-1 col-md-1 col-lg-1 me-4 ms-2">
            <Link to="/view" className="nav-link text-info">
              Pending Bookings
            </Link>
          </div>
          <div className="col-sm-1 col-md-1 col-lg-1 me-3 ms-2">
            <Link to="/bookings" className="nav-link text-info">
              View Bookings
            </Link>
          </div>
          <div className="col-sm-1 col-md-1 col-lg-1 p ms-2 me-5">
            <Link to="/profile" className="nav-link text-info">
              
            </Link>
          </div>
          <div className="col-sm-1 col-md-1 col-lg-1 me-4 ms-5">
