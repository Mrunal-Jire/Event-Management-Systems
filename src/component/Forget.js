...
function Forget() {
      ...
      (response) => {
        ...
        if (response.data.length == 0) {
          ...
          swal.fire({
            ...
            text:
              'Now you can set a new password by answering security question and I hope you dont forget this one',
          })
      ...
      (response) => {
        ...
        if (response.data.length == 0) {
          swal.fire({
            title: 'Oh NO!',
            text:
              'Your answer does not match the one you have entered during registration',
            icon: 'error',
          })
          ...
          swal
            .fire({
              ...
              title: 'Finally!!!',
              text:
                'You have reset the password.Keep it safe and remember it for login',
            })
            .then(function () {
              window.location = '/'
            })
  ...
  const validate = (e) => {
    ...
    } else if (usera.length <= 2 || usera.length > 40) {
        ...
        <div className="row d-flex justify-content-center">
          <div className="col-md-12">
            <div className=" z-depth-3 mt-3">
              <div className="col-sm-12 rounded-right bg-dark text-white p-4 mt-2  m-auto">
